(function($) {
  ...
  function displayButton(type, icon, lang, id, button_class, options, defaults)
  {
    ...
    {
      case 'bold':
        value = '<button class="' + button_class + '" id="bbcodeditor-head-btn-bold-' + id + '" data-toggle="tooltip" data-placement="top" title="' + lang['font']['bold'] + '" type="button">' + icon['bold'] + '</button>';
        break;
      case 'italic':
        value = '<button class="' + button_class + '" id="bbcodeditor-head-btn-italic-' + id + '" data-toggle="tooltip" data-placement="top" title="' + lang['font']['italic'] + '" type="button">' + icon['italic'] + '</button>';
        break;
      case 'underline':
        value = '<button class="' + button_class + '" id="bbcodeditor-head-btn-underline-' + id + '" data-toggle="tooltip" data-placement="top" title="' + lang['font']['underline'] + '" type="button">' + icon['underline'] + '</button>';
        break;
      case 'strikethrough':
        value = '<button class="' + button_class + '" id="bbcodeditor-head-btn-strikethrough-' + id + '" data-toggle="tooltip" data-placement="top" title="' + lang['font']['strikethrough'] + '" type="button">' + icon['strikethrough'] + '</button>';
        break;
      case 'supperscript':
        value = '<button class="' + button_class + '" id="bbcodeditor-head-btn-supperscript-' + id + '" data-toggle="tooltip" data-placement="top" title="' + lang['font']['supperscript'] + '" type="button">' + icon['superscript'] + '</button>';
        break;
      case 'subscript':
        value = '<button class="' + button_class + '" id="bbcodeditor-head-btn-subscript-' + id + '" data-toggle="tooltip" data-placement="top" title="' + lang['font']['subscript'] + '" type="button">' + icon['subscript'] + '</button>';
        break;
      case 'font-name':
        value = '<div class="dropdown" data-toggle="tooltip" data-placement="top" title="' + lang['font']['font_name'] + '">';
        ...
        break;
      case 'font-size':
        value = '<div class="dropdown" data-toggle="tooltip" data-placement="top" title="' + lang['font']['font_size'] + '">';
        ...
        break;
      case 'color':
        value = '<button class="' + button_class + '" id="bbcodeditor-head-btn-color-' + id + '" data-toggle="tooltip" data-placement="top" title="' + lang['font']['color']['button'] + '" type="button">' + icon['color'] + '</button>';
        break;
      case 'unordered-list':
        value = '<button class="' + button_class + '" id="bbcodeditor-head-btn-unordered-list-' + id + '" data-toggle="tooltip" data-placement="top" title="' + lang['text']['unordered_list'] + '" type="button">' + icon['unordered_list'] + '</button>';
        break;
      case 'ordered-list':
        value = '<button class="' + button_class + '" id="bbcodeditor-head-btn-ordered-list-' + id + '" data-toggle="tooltip" data-placement="top" title="' + lang['text']['ordered_list'] + '" type="button">' + icon['ordered_list'] + '</button>';
        break;
      case 'align':
        value = '<div class="dropdown" data-toggle="tooltip" data-placement="top" title="' + lang['text']['align']['button'] + '">';
        ...
        break;
      case 'link':
        value = '<button class="' + button_class + '" id="bbcodeditor-head-btn-link-' + id + '" data-toggle="tooltip" data-placement="top" title="' + lang['inserts']['link']['button'] + '" type="button">' + icon['link'] + '</button>';
        break;
      case 'image':
        value = '<button class="' + button_class + '" id="bbcodeditor-head-btn-image-' + id + '" data-toggle="tooltip" data-placement="top" title="' + lang['inserts']['image']['button'] + '" type="button">' + icon['image'] + '</button>';
        break;
      case 'media':
        value = '<button class="' + button_class + '" id="bbcodeditor-head-btn-media-' + id + '" data-toggle="tooltip" data-placement="top" title="' + lang['inserts']['media']['button'] + '" type="button">' + icon['media'] + '</button>';
        break;
      case 'misc':
        value = '<button class="' + button_class + '" id="bbcodeditor-head-btn-misc-' + id + '" data-toggle="tooltip" data-placement="top" title="' + lang['inserts']['misc']['button'] + '" type="button">' + icon['misc'] + '</button>';
        break;
      case 'advcode':
        value = '<button class="' + button_class + '" id="bbcodeditor-head-btn-advcode-' + id + '" data-toggle="tooltip" data-placement="top" title="' + lang['inserts']['advcode']['button'] + '" type="button">' + icon['advcode'] + '</button>';
        break;
      case 'table':
        value = '<button class="' + button_class + '" id="bbcodeditor-head-btn-table-' + id + '" data-toggle="tooltip" data-placement="top" title="' + lang['inserts']['table']['button'] + '" type="button">' + icon['table'] + '</button>';
        break;
      case 'preview':
        value = '<button class="' + button_class + '" id="bbcodeditor-head-btn-preview-' + id + '" data-toggle="tooltip" data-placement="top" title="' + lang['preview']['button'] + '" type="button">' + icon['preview'] + '</button>';
        break;
    }
  ...
  function displayModal(type, lang, id, options, defaults)
  {
    ...
    switch(type)
    {
      ...
      case 'advcode':
        ...
        value += '<textarea class="form-control bbcodeditor-modal-advcode-input" id="bbcodeditor-modal-advcode-input-' + id + '"></textarea>';
  ...
  $.fn.bbcodeditor = function(options) {
    ...
    var footer_text_left = 'BBCode Editor - 1.0';
    ...
    console.log('%c The BBCode Editor Pluing was successfully initiated!', 'background: #2C3E50; color: white');
    console.log('%c Version: 1.0', 'background: #2C3E50; color: white');
    console.log('%c Created By: MrAnonymusz.', 'background: #2980B9; color: white');
    console.log('%c Contact Link: https://projects.annotech.net', 'background: #27AE60; color: white');
    ...
    footer_template += '<span class="text">By <a href="https://projects.annotech.net" target="_blank">MrAnonymusz</a></span>';
    footer_template += '</div>';
    ...
    const color_picker = Pickr.create({
      el: '#bbcodeditor-modal-color-picker-' + editor_id,
      theme: 'monolith',
      default: colorPickerDefaultColor,
    ...
    $('.pcr-button').css('width', '100%');

    color_picker.on('save', function() {
      var selected_color = color_picker.getSelectedColor().toRGBA().toString(3);
      var color_output = $('#bbcodeditor-modal-color-picker-output-' + editor_id);

      color_picker.hide();

      color_output.val(selected_color);
    });
    ...
    $('#bbcodeditor-modal-table-column-value-' + editor_id).inputmask({"mask": "99"});
    $('#bbcodeditor-modal-table-row-value-' + editor_id).inputmask({"mask": "99"});
